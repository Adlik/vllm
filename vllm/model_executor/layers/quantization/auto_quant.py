...
class AutoQuantConfig(QuantizationConfig):
    ...
    def __init__(
            ...
            zero_point: bool,
            from_float: bool,
            quant_mode: str,  # llm_int8, smoothquant, weight_only, fp6, marlin
    ) -> None:
        ...
        if isinstance(
            ...
            if quant_config.from_float:
                ...
                if quant_config.quant_mode in ("llm_int8", "smoothquant"):
                    ...
                    set_weight_attrs(param_qweight, module.linear_method.extra_weight_attrs)
                    set_weight_attrs(param_scales_zeros, module.linear_method.extra_weight_attrs)
                    del _qzeros
                    del _scales
                    del param
